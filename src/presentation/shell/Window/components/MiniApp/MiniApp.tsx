...
import { getAppConfig, calculateWindowPosition } from '@/src/domain/shell/window/config/AppConfig';
import { MiniAppWindowState } from '@/src/domain/shell/window/stores/WindowStore';
import { Window } from '@/src/presentation/shell/Window';
